...
VAE_MODELS=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/zImageClearVae_natural.safetensors"
)
...
BBOX_0=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/face_yolov8s.pt"
)

BBOX_1=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/femaleBodyDetection_yolo26.pt"
)

BBOX_2=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/female_breast-v4.2.pt"
)

BBOX_3=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/nipples_yolov8s.pt"
)

BBOX_4=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/vagina-v4.2.pt"
)

BBOX_5=(
    "https://huggingface.co/GerbyHorty76/clearvae/blob/main/assdetailer.pt"
)
...
UPSCALER_MODELS=(
    "https://huggingface.co/GerbyHorty76/clearvae/resolve/main/4xUltrasharp_4xUltrasharpV10.pt"
)
...
function provisioning_start() {
    ...
    echo "# incubator X-MODE setup 2025-2026               #"
    ...
    echo ""
    echo "team настроил → Starting ComfyUI..."
    echo ""
}

function provisioning_clone_comfyui() {
    if [[ ! -d "${COMFYUI_DIR}" ]]; then
        echo "team клонирует ComfyUI..."
...
function provisioning_install_base_reqs() {
    if [[ -f requirements.txt ]]; then
        echo "team установливает base requirements..."
...
function provisioning_get_apt_packages() {
    if [[ ${#APT_PACKAGES[@]} -gt 0 ]]; then
        echo "team устанавливает apt packages..."
...
function provisioning_get_pip_packages() {
    if [[ ${#PIP_PACKAGES[@]} -gt 0 ]]; then
        echo "team устанавливает extra pip packages..."
